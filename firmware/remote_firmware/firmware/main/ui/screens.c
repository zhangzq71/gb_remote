...
void create_screen_splash_screen() {
    ...
    lv_obj_set_style_bg_img_src(obj, &img_splash, LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        lv_obj_t *parent_obj = obj;
        {
            // splash_arc
            lv_obj_t *obj = lv_slider_create(parent_obj);
            objects.splash_arc = obj;
            lv_obj_set_pos(obj, 59, 350);
            lv_obj_set_size(obj, 250, 7);
...
void create_screen_home_screen() {
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(0xff000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_img_set_zoom(obj, 280);
        }
        {
            // controller_battery
            lv_obj_t *obj = lv_img_create(parent_obj);
            objects.controller_battery = obj;
            lv_obj_set_pos(obj, 289, 32);
            ...
            lv_img_set_zoom(obj, 400);
            {
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
                    lv_img_set_src(obj, &img_light_white);
        ...
        }
        {
            ...
            lv_obj_set_pos(obj, 0, 0);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_obj_set_style_text_font(obj, &ui_font_bebas200, LV_PART_MAIN | LV_STATE_DEFAULT);
...
void create_screen_shutdown_screen() {
    ...
    lv_obj_set_style_bg_opa(obj, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        lv_obj_t *parent_obj = obj;
        {
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.obj0 = obj;
            lv_obj_set_pos(obj, 98, 298);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_obj_set_style_text_color(obj, lv_color_hex(0xffffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_text_opa(obj, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_text_font(obj, &ui_font_bebas35, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_label_set_text(obj, "Shutting down");
        }
        {
            // splash_arc_1
            lv_obj_t *obj = lv_slider_create(parent_obj);
            objects.splash_arc_1 = obj;
            lv_obj_set_pos(obj, 59, 375);
